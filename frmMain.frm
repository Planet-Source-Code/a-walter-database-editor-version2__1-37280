...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame fraSqlStatement 
      ...
      Top             =   4560
      Width           =   7455
      Begin VB.CommandButton cmdExecutes 
         Caption         =   "Execute"
         Height          =   495
         Left            =   6240
         TabIndex        =   3
   ...
   Begin VB.Menu mnuFile 
      Caption         =   "&File"
      Begin VB.Menu mnuNewAccess 
         Caption         =   "New Access Database"
         Shortcut        =   ^N
      End
   ...
   Begin VB.Menu mnuedit 
      ...
      Begin VB.Menu mnuedittable 
         Caption         =   "Edit Table Information"
      End
      Begin VB.Menu mnuSep3 
         Caption         =   "-"
      End
      Begin VB.Menu mnunewadd 
         Caption         =   "New Add Table"
      End
   End
End
...
Private Sub Form_Resize()
    ...
    If mnuShowSQL.Checked = True And Frame1.Visible = True Then
    ...
    If mnuShowSQL.Checked = True Then
        gridData.Height = Me.Height - gridData.Top - 2000 - Frame1.Height
    Else
        gridData.Height = Me.Height - gridData.Top - 1050 - Frame1.Height
    End If
    ...
    txtSqlStatement.Width = fraSqlStatement.Width - txtSqlStatement.Left - cmdExecutes.Width - 200
    
    'Top
    imgLoading.Top = Me.Height - 950
    lblStatus.Top = Me.Height - 950
    fraSqlStatement.Top = gridData.Top + gridData.Height + 100
    Frame1.Top = fraSqlStatement.Top + fraSqlStatement.Height + 100
    ...
    cmdExecutes.Left = txtSqlStatement.Left + txtSqlStatement.Width + 100
...
Dim Password As String
    ...
    If rsSchema.RecordCount <= 0 Then
        ...
        fraSqlStatement.Visible = False
        'Me.mnuRenameColumn.Enabled = False
        Me.mnuedittable.Enabled = False
        
        'mnuPurgeDate.Enabled = False
        'Me.mnuRenameTable.Visible = False
        'Me.mnuAddColumn.Visible = False
        
        
        fraSqlStatement.Visible = False
    Else
        Me.cmbTables.Visible = True
        'Me.gridData.Visible = True
        'mnuPurgeDate.Enabled = True
        Me.mnuedittable.Enabled = True
        
        'Me.mnuRenameTable.Visible = True
        'Me.mnuAddColumn.Visible = True
        'Me.mnuRenameColumn.Enabled = True
        
        'Me.fraSqls.Visible = True
        If mnuShowSQL.Checked = True Then
        fraSqlStatement.Visible = True
        End If
        
        Me.Frame1.Visible = True
        'Me.mnuPurgeDate.Enabled = True
    ...
    If dbObj.State <> adStateOpen And (dbType = e_databaseTypes_AccessFile Or e_databaseTypes_MicrosoftAccess2KFile Or e_databaseTypes_MicrosoftAccess97File) Then
        ...
        dbConnectionString = dbConnectionString & "PWD=;"
        dbObj.Open dbConnectionString
        'Unload frmPassword
...
'MsgBox "test"
    ...
    adoData.ConnectionString = ""
    adoData.ConnectionString = dbConnectionString
    'MsgBox txtSqlStatement.Text & "   " & dirty
    
    'MsgBox "test"
    
    If txtSqlStatement.Text = "" And dirty2 = False Then
        adoData.RecordSource = "SELECT * FROM " & ResolveTable(cmbTables.Text)
        adoData.Refresh
        txtSqlStatement = adoData.RecordSource
    ElseIf dirty2 = True And txtSqlStatement <> "" Then
        adoData.RecordSource = txtSqlStatement
        adoData.Refresh
    Else
        adoData.RecordSource = "SELECT * FROM " & ResolveTable(cmbTables.Text)
...
Private Sub mnuNewAccess_Click()
...
Dim lastFile As String
    ...
    newFile = SelectFile("Select Database", "Microsoft Access Database (*.mdb)" & Chr$(0) & "*.mdb", &H4 + &H1000, "mdb", True, lastFile)
    
    If Trim(newFile) = "" Then Exit Sub
    
    cat.Create "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & newFile
    If newFile <> "" Then
        LastOpenedType = e_LastOpened_Access
        dbPath = newFile
        dbType = e_databaseTypes_AccessFile
        If lastFile <> newFile Then
            Call SaveSetting(App.Title, DEF_REGISTRY_CONNECTIONS & "\" & DEF_ACCESS, "Database Password", "", HKEY_LOCAL_MACHINE, "SOFTWARE\Database")
        End If
...
'Private Sub resizes_Click()
'MsgBox "test"

'Load frmResizeColumn
...
ado.Open adoData.ConnectionString




ado.Execute (Text1.Text)
Text1.Text = ""
...
Private Sub txtSqlStatement_Change()
    ...
    If Trim(txtSqlStatement) = "" Then
        cmdExecutes.Enabled = False
    Else
        cmdExecutes.Enabled = True
        'cmdExecutes.Default = True
        If LockTextBox = False Then
            LockTextBox = True
...
Private Sub txtSqlStatement_GotFocus()
